...
public:
    ...
    // Virtual function for calculating bonus
    virtual int calculateBonus()
    {
        return 0; // Base implementation, can be overridden by derived classes
    }

    employee()
    {
        cout<<"Employee Class Instantiated"<<endl;
    }
...
public:
    ...
    // Constructor
    FullTimeEmployee(const char *empName, int empCode, int empAge, int empSalary, int empExp, const char *empDesignation)
    {
        strcpy(name, empName);
        code = empCode;
        age = empAge;
    ...
    // Override the virtual function to calculate bonus for full-time employees
    int calculateBonus() override
    {
        return 0.1 * salary; // Example: 10% of salary as bonus
    }
};
...
public:
    ...
    // Constructor
    PartTimeEmployee(const char *empName, int empCode, int empAge, int empHourlyRate, int empHoursWorked)
    {
        strcpy(name, empName);
        code = empCode;
        age = empAge;
    ...
    // Override the virtual function to calculate bonus for part-time employees
    int calculateBonus() override
    {
        return hourlyRate * hoursWorked; // Example: Pay for hours worked as bonus
    }
};
